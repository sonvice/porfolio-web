...
<Picture src={img1} widths={[720, img1.width]}  sizes={`(min-width: 39.9em) 720px`} alt="Hero con texto central más dos botones de llamada a la acción"/>
...
<Picture src={img2} widths={[720, img2.width]} sizes={`(min-width: 39.9em) 720px`} alt="Dos partes texto y formulario, y un seudoelemento en el pie de nuestro hero sección"/>
...
<Picture src={img3} widths={[720, img3.width]} sizes={`(min-width: 39.9em) 720px`} alt="Dos secciones texto e imagen con seudoelemento en la imagen"/>
...
<Picture  widths={[720, gridArea.width]} sizes={`(min-width: 39.9em) 720px`}  src={gridArea} alt="Gif mostrando las grid áreas en firefox"/>
...
</header>`} lang='html' theme="monokai" />
...
<Picture  widths={[720, imgHeroArea.width]} sizes={`(min-width: 39.9em) 720px`}  src={imgHeroArea} alt="Gif mostrando las grid áreas en firefox"/>
