...
date: 2025-10-14
featured: false
cover: ./images/cap-1-accesibilidad-web/cap-1-accessibility-web.jpg
title: > 
...
> <p> Siguiente: [Capítulo 2: Estructuración de páginas — Landmarks, ...](/blog/estructuracion-de-paginas-landmarks-encabezados-orden-dom)</p>  

import Table from "@components/Table.jsx";

export const columns = [
  { accessorKey: "lector", header: "Lector de Pantalla" },
  { accessorKey: "atajo", header: "Atajo/Navegación" },
];
...
export const data = [
  ...
  {
    lector: "VoiceOver (macOS/iOS)",
    atajo: "navegación por regiones",
  },
  {
    lector: "TalkBack (Android)",
    atajo: "gestos por secciones",
  },
];
