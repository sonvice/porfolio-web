...
date: 2024-01-02
featured: false
image: ./images/design-thinking-aplicado-a-web/design-thinking-web.jpg
...
---
import { designThinkig,diagrama } from './images/design-thinking-aplicado-a-web'
import { Picture } from "astro:assets"

<Picture quality={100} src={diagrama} widths={[720, diagrama.width]}  sizes={`(min-width: 39.9em) 720px`} alt="Esquema del combinador de hermanos adyacentes (+)"/>
> Como seres humanos, debemos lidiar con problemas todos los días. Pero, ¿cómo podemos encontrar soluciones eficaces a problemas cotidianos teniendo en cuenta siempre las necesidades de las personas?. De esta manera se dio inicio a la metodología de Design Thinking. 

## ¿Qué es Design Thinking?


Design Thinking es un enfoque centrado en el usuario que se utiliza para abordar problemas complejos y encontrar soluciones innovadoras. Los pasos típicos del Design Thinking son:
...
Design Thinking se ha convertido en un enfoque ampliamente adoptado en el diseño y la innovación empresarial, influyendo en la resolución de problemas de manera creativa y orientada al usuario. Se ha convertido en una herramienta valiosa para empresas que buscan soluciones efectivas y centradas en el cliente.

## Fases del Design Thinking Aplicados al Diseño Web Responsive
<Picture quality={100} src={designThinkig} widths={[720, designThinkig.width]}  sizes={`(min-width: 39.9em) 720px`} alt="Esquema del combinador de hermanos adyacentes (+)"/>
Estos son los pasos comunes del proceso de diseño centrado en el usuario, aplicados específicamente al diseño web responsive:
...
**Definición:** Con base en la información recopilada, define claramente los objetivos del diseño y los problemas específicos que estás tratando de resolver.  
Establece criterios de éxito para medir el rendimiento.  
**Acciones:**
...
**Acciones:**
Utiliza herramientas de diseño como Figma o [Penpot que es de codigo abierto para crear wireframes](https://penpot.app/).  
...
**Acciones:**
Colabora con desarrolladores para [implementar el diseño](https://wilsonmunoz.com/guia-completa-para-maquetar-un-diseno-de-figma-en-html5-y-css3/).
...
Incluir los pasos de "Implementar" y "Evaluar y Mejorar" es crucial en un proceso de diseño centrado en el usuario por varias razones:

### **Implementar:**

**Integración con el Desarrollo:** La implementación se refiere a la fase en la que el diseño se traduce en código y se integra en el entorno tecnológico real.  
Incluir este paso garantiza que los diseñadores trabajen en colaboración estrecha con los desarrolladores para asegurar que la visión del diseño se refleje fielmente en la versión final del producto o sitio web.  
...
**Retroalimentación Post-Implementación:** La evaluación y mejora continúan incluso después de la implementación para garantizar que el diseño cumpla con las expectativas y resuelva los problemas identificados en las etapas anteriores.  
La retroalimentación post-implementación puede provenir de usuarios reales y observaciones en condiciones del mundo real.  
